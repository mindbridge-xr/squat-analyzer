...
export const SquatCounter: React.FC<SquatCounterProps> = ({ 
  ...
  const updatePhase = useCallback((newPhase: 'standing' | 'descending' | 'bottom' | 'ascending') => {
  ...
  }, [metrics, currentPhase, previousKneeAngle, bottomReached, updatePhase, onSquatComplete]);
